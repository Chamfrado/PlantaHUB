-- =========================================================================
-- V28 - Conteudo editorial dos 6 produtos existentes
--
-- Snapshot unico, GERADO PROGRAMATICAMENTE a partir de
-- apps/web/plantahub-web/src/data/products.ts, para que nenhum texto se perca
-- numa transcricao manual. E o que permite apagar aquele arquivo do frontend
-- sem regressao visual.
--
-- Isto e bootstrap, nao fonte da verdade: a partir de agora todo o conteudo e
-- editado pelo painel. Esta migration nunca deve ser reeditada para "corrigir
-- um texto" — faca isso pelo admin.
-- =========================================================================

-- casa-confort-80m2
UPDATE product SET content = '{
  "headline": "Confort - 80 m2",
  "subheadline": "Kitnet Moderna",
  "description": "Transforme sua experiência de construir uma casa com um projeto arquitetônico maravilhoso.",
  ...
  "whyChooseFeatures": [
    {
      ...
      "description": "Inclui todas as plantas essenciais: Arquitetônica, Hidráulica, Elétrica, Estrutural e Paisagística. Soluções ecológicas garantindo soluções sustentáveis. Lista de materiais detalhada e manual de construção."
    },
    {
      "title": "Acesso Imediato",
      "description": "Download digital imediato na confirmação da compra. Arquivos em formatos BIM, DWG e PDF para uso versátil."
    },
    {
  ...
  "keyFacts": [
    {
      "value": "80",
      "label": "metros quadrados de espaço habitavel"
    },
    {
      "value": "5+",
      "label": "Plantas diferentes inclusas"
    }
  ],
  ...
  "testimonials": [
    ...
    {
      "quote": "“Casa Confort me deu um design incrível! É funcional e ao mesmo tempo estilosa!” .",
...
WHERE id = 'casa-confort-80m2' AND content = '{}'::jsonb;

-- casa-prime-150m2
UPDATE product SET content = '{
  "headline": "Prime - 150 m2",
  "subheadline": "Casa Moderna Familiar",
  "description": "Um projeto completo com espaços amplos, integração inteligente e estética contemporânea para vida em família.",
  ...
  "includedItems": [
    {
      "title": "Planta Arquitetônica",
      "description": "Layout detalhado com dimensões e organização dos ambientes."
    },
    {
      "title": "Planta Hidráulica",
      "description": "Pontos de água, esgoto e drenagem otimizados."
    },
    {
      "title": "Planta Elétrica",
      "description": "Distribuição de circuitos, tomadas e iluminação."
    },
    {
      "title": "Planta Estrutural",
      "description": "Referência estrutural para segurança e durabilidade."
    },
    {
      "title": "Planta Paisagística",
      "description": "Sugestões para área externa e valorização do imóvel."
    },
    {
      "title": "Lista de Materiais + Guia",
      "description": "Base para orçamento e orientações gerais de execução."
    }
  ],
  ...
  "keyFacts": [
    ...
    {
      "value": "5+",
      "label": "itens e plantas inclusos"
    }
  ],
  ...
  "testimonials": [
    {
      "quote": "“O projeto veio muito organizado e facilitou o orçamento.”",
      "authorName": "Cliente Prime"
    },
    {
      "quote": "“A integração dos ambientes ficou excelente para a família.”",
      "authorName": "Cliente Prime"
    }
  ],
  "faqTitle": "Perguntas Frequentes",
...
WHERE id = 'casa-prime-150m2' AND content = '{}'::jsonb;

-- casa-diamond-300m2
UPDATE product SET content = '{
  "headline": "Diamond - 300 m2",
  "subheadline": "Casa Premium de Alto Padrão",
  "description": "Um projeto premium com presença arquitetônica forte, alto nível de detalhamento e base perfeita para personalizações.",
  ...
  "whyChooseFeatures": [
    {
      ...
      "description": "Linhas contemporâneas e proposta sofisticada."
    },
    {
      "title": "Detalhamento para execução",
      "description": "Estrutura de documentação para uma obra mais previsível."
    },
    {
      "title": "Personalização facilitada",
      "description": "Base robusta para adaptar acabamentos e layout."
    }
  ],
  "includesTitle": "O que está incluso na sua compra?",
  ...
  "includedItems": [
    {
      "title": "Planta Arquitetônica",
      "description": "Distribuição completa e cotas de referência."
    },
    {
      "title": "Planta Hidráulica",
      "description": "Pontos e prumadas com foco em eficiência."
    },
    {
      "title": "Planta Elétrica",
      "description": "Pontos elétricos e iluminação com organização."
    },
    {
      "title": "Planta Estrutural",
      "description": "Base estrutural para segurança e durabilidade."
    },
    {
      "title": "Planta Paisagística",
      "description": "Ideias para área externa e valorização estética."
    },
    {
      "title": "Memorial + Lista de Materiais",
      "description": "Apoio para orçamento, execução e alinhamento técnico."
    }
  ],
  ...
  "testimonials": [
    {
      "quote": "“Material muito completo, ajudou a alinhar toda a obra.”",
      "authorName": "Cliente Diamond"
    },
    {
      "quote": "“A base é excelente para personalizar sem dor de cabeça.”",
      "authorName": "Cliente Diamond"
    }
  ],
  "faqTitle": "Perguntas Frequentes",
...
WHERE id = 'casa-diamond-300m2' AND content = '{}'::jsonb;

-- chale-confort-55m2
UPDATE product SET content = '{
  "headline": "Confort - 55 m2",
  "subheadline": "Chalé Compacto Aconchegante",
  "description": "Um chalé compacto, aconchegante e perfeito para sítio, serra ou projeto de hospedagem com construção otimizada.",
  "whyChooseTitle": "Por Quê escolher o Chalé Confort?",
  "whyChooseIntro": "Foco em custo-benefício, simplicidade e beleza.",
  "whyChooseFeatures": [
    {
      "title": "Compacto e funcional",
      "description": "Ótimo aproveitamento interno, com circulação inteligente."
    },
    {
      "title": "Pronto para construir",
      "description": "Documentação base para execução com menos retrabalho."
    },
    {
      "title": "Ideal para locação",
      "description": "Perfeito para chalé de final de semana e Airbnb."
    }
  ],
  "includesTitle": "O que está incluso na sua compra?",
  ...
  "includedItems": [
    {
      "title": "Planta Arquitetônica",
      "description": "Layout, medidas e organização dos ambientes."
    },
    {
      "title": "Planta Hidráulica",
      "description": "Pontos de água, esgoto e drenagem."
    },
    {
      "title": "Planta Elétrica",
      "description": "Tomadas, iluminação e circuitos com organização."
    },
    {
      "title": "Planta Estrutural",
      "description": "Base estrutural para segurança e durabilidade."
    },
    {
      ...
      "description": "Referência para orçamento e compras."
    },
    {
      "title": "Guia de Ajustes",
      "description": "Orientações de personalização e adaptação."
    }
  ],
  ...
  "testimonials": [
    {
      "quote": "“Projeto prático e bonito, deu pra orçar rápido.”",
      "authorName": "Cliente Chalé"
    },
    {
      "quote": "“Ótimo para hospedagem, bem distribuído.”",
      "authorName": "Cliente Chalé"
    }
  ],
  "faqTitle": "Perguntas Frequentes",
...
WHERE id = 'chale-confort-55m2' AND content = '{}'::jsonb;

-- chale-prime-85m2
UPDATE product SET content = '{
  "headline": "Prime - 85 m2",
  "subheadline": "Chalé Familiar com Varanda",
  "description": "Mais espaço, varanda valorizada e integração sala/cozinha para um chalé confortável e com alto potencial de locação.",
  "whyChooseTitle": "Por Quê escolher o Chalé Prime?",
  "whyChooseIntro": "O equilíbrio perfeito entre conforto, estética e praticidade.",
  "whyChooseFeatures": [
    {
      "title": "Varanda valorizada",
      "description": "Aumenta conforto e agrega valor ao imóvel."
    },
    {
      "title": "Planta bem distribuída",
      "description": "Separação clara entre social e íntimo."
    },
    {
      "title": "Base completa",
      "description": "Documentação para obra com menos incertezas."
    }
  ],
  "includesTitle": "O que está incluso na sua compra?",
  ...
  "includedItems": [
    {
      "title": "Planta Arquitetônica",
      "description": "Layout detalhado e dimensões."
    },
    {
      "title": "Planta Hidráulica",
      "description": "Distribuição de pontos e drenagem."
    },
    {
      "title": "Planta Elétrica",
      "description": "Iluminação e pontos elétricos."
    },
    {
      "title": "Planta Estrutural",
      "description": "Referência estrutural para execução."
    },
    {
      "title": "Planta Paisagística",
      "description": "Ideias para compor área externa."
    },
    {
      "title": "Lista de Materiais + Guia",
      "description": "Apoio no orçamento e execução."
    }
  ],
  ...
  "testimonials": [
    {
      "quote": "“A varanda fez toda a diferença no projeto.”",
      "authorName": "Cliente Chalé Prime"
    },
    {
      "quote": "“Documentação bem feita e fácil de repassar para a equipe.”",
      "authorName": "Cliente Chalé Prime"
    }
  ],
  "faqTitle": "Perguntas Frequentes",
...
WHERE id = 'chale-prime-85m2' AND content = '{}'::jsonb;

-- chale-diamond-120m2
UPDATE product SET content = '{
  "headline": "Diamond - 120 m2",
  "subheadline": "Chalé Premium de Alto Padrão",
  "description": "Um chalé premium com presença arquitetônica forte, ideal para experiências exclusivas e locação de alto valor agregado.",
  ...
  "whyChooseFeatures": [
    {
      ...
      "description": "Proposta premium para se destacar na locação."
    },
    {
      "title": "Experiência valorizada",
      "description": "Ambientes pensados para conforto e percepção de luxo."
    },
    {
      "title": "Base robusta para customização",
      "description": "Adapte acabamentos e layout com facilidade."
    }
  ],
  "includesTitle": "O que está incluso na sua compra?",
  ...
  "includedItems": [
    ...
    {
      "title": "Planta Elétrica",
      "description": "Iluminação, tomadas e circuitos organizados."
    },
    {
      "title": "Planta Estrutural",
      "description": "Base estrutural para segurança e durabilidade."
    ...
    {
      "title": "Planta Paisagística",
      "description": "Ideias para área externa premium."
    },
    {
      "title": "Memorial + Lista de Materiais",
      "description": "Apoio de orçamento e execução."
    }
  ],
  ...
  "testimonials": [
    {
      "quote": "“Projeto perfeito para locação premium, muito bem pensado.”",
      "authorName": "Cliente Chalé Diamond"
    },
    {
      "quote": "“Base excelente para personalizar e executar sem surpresas.”",
      "authorName": "Cliente Chalé Diamond"
    }
  ],
  "faqTitle": "Perguntas Frequentes",
...
WHERE id = 'chale-diamond-120m2' AND content = '{}'::jsonb;
