          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
                ...
                <div className="mt-4">
                  <button className="w-full rounded-xl border border-neutral-300 bg-white font-semibold cursor-pointer text-brand-black hover:bg-neutral-100 transition inline-flex items-center justify-center gap-2 py-3">
            ...
            <div className="lg:col-span-2">
              <div className="rounded-2xl border border-neutral-200 bg-white p-6 md:p-8 shadow-sm">
                <h2 className="text-2xl font-extrabold text-brand-black">Envie uma mensagem</h2>
                    ...
                    <button
                      ...
                      className={[
                        ...
                        isValid
                          ...
                          : 'bg-neutral-200 text-brand-muted cursor-not-allowed',
                      ].join(' ')}
                    >
              ...
              <div className="mt-6 rounded-2xl border border-neutral-200 bg-white overflow-hidden shadow-sm">
                <div className="p-6 md:p-8">
                  <h3 className="text-lg font-extrabold text-brand-black">Atendimento remoto</h3>
                  <p className="mt-2 text-sm text-brand-muted">
                ...
                <div className="h-56 bg-neutral-100 border-t border-neutral-200 flex items-center justify-center text-brand-muted text-sm">
    ...
    <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-brand-muted leading-relaxed">{text}</p>
          <div className="mt-3 text-sm font-semibold text-brand-black">{line}</div>
        </div>
      </div>
    </div>
  );
...
function MiniPill({ icon, text }: { icon: React.ReactNode; text: string }) {
  return (
    <div className="rounded-xl border border-neutral-200 bg-white px-4 py-3 text-sm font-semibold text-brand-black inline-flex items-center gap-2">
